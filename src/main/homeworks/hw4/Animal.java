...
public abstract class Animal {
    ...
    /*Статическое поле animalCounter будет пренадлежать всему классу, а не его экземплярам,
    * таким образом реализуем счётчик всех созданных животных.*/
    private static int animalCounter = 0;
    public Animal(){
        animalCounter++;    //Увеличиваем счётчик при каждом создании объекта-наследника класса Animal
    }
